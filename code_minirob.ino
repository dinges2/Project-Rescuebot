...
void setup(){
    ...
    //set pins as input pullup reed sensor
...
void loop(){
  ...
  int stateReed1 = 1 - digitalRead(reed1);
  int stateReed2 = 1 - digitalRead(reed2);
  
  //call the ultrasonic sensor function
